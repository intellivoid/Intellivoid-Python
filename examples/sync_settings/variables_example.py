...
current_data = settings_manager.dump()  # Let's get the data first and see what's on it
...
current_data = settings_manager.dump()
...
settings_manager.append("inventory", found_item)  # Let's add that to the inventory!
